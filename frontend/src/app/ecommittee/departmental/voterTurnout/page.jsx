    ...
    try {
      ...
      setTimeout(() => {
        setTurnoutData({
          ...
          votersWhoVoted: 98,
          votersWhoDidntVote: 52,
          turnoutPercentage: 65,
          departmentBreakdown: [
            { department: "College of Computer Studies", total: 80, voted: 55, percentage: 69 },
            { department: "College of Education", total: 70, voted: 43, percentage: 61 },
          ],
        })
        setLoading(false)
      }, 1000)
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mt-2">Departmental Election Voter Turnout</h1>
          <p className="text-gray-600">Monitor voter participation in departmental elections</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Turnout by Department</h2>
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {turnoutData?.departmentBreakdown?.map((department, index) => (
                  <tr key={index} className="hover:bg-purple-50/50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                      {department.department}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{department.total}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600 font-medium">
                      {department.voted}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600 font-medium">
                      {department.total - department.voted}
                    </td>
