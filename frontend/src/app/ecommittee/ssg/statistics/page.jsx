    ...
    try {
      ...
      setTimeout(() => {
        setStatistics({
          ...
          voterTurnout: 78,
          positions: [
            { name: "President", candidates: 2, votes: 150 },
            { name: "Vice President", candidates: 2, votes: 142 },
            { name: "Secretary", candidates: 2, votes: 89 },
            { name: "Treasurer", candidates: 2, votes: 75 },
          ],
        })
        setLoading(false)
      }, 1000)
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mt-2">SSG Election Statistics</h1>
          <p className="text-gray-600">View detailed statistics for SSG election</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Vote Distribution by Position</h2>
          <div className="space-y-4">
            {statistics?.positions?.map((position, index) => (
              <div key={index} className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{position.candidates} candidates</p>
                  </div>
                  <div className="text-right">
                    <p className="text-2xl font-bold text-purple-600">{position.votes}</p>
