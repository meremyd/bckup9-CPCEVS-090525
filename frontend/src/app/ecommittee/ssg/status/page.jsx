    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mt-2">SSG Election Status</h1>
          <p className="text-gray-600">Current election configuration and status</p>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Ballot Open Time</label>
                  <p className="text-lg font-semibold text-gray-900 bg-gray-50 px-4 py-2 rounded-lg">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Ballot Close Time</label>
                  <p className="text-lg font-semibold text-gray-900 bg-gray-50 px-4 py-2 rounded-lg">
