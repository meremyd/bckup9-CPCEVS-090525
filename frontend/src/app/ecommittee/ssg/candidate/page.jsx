...
export default function SSGCandidatesPage() {
  ...
  const fetchCandidates = async () => {
    try {
      ...
      // const response = await fetch("http://localhost:5000/api/candidates/ssg", {
        ...
        setCandidates([
          {
            ...
            platform: "Excellence in Education",
            votes: 150,
          },
          {
            _id: "2",
            ...
            partylist: "Progress Alliance",
            platform: "Student Welfare and Development",
            votes: 142,
          },
        ])
        setLoading(false)
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-800 mt-2">SSG Election Candidates</h1>
            <p className="text-gray-600">Manage candidates for SSG election</p>
          </div>
        </div>
            ...
            <table className="min-w-full">
              <thead className="bg-purple-600 text-white">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-sm font-medium uppercase tracking-wider">Partylist</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {candidates.map((candidate) => (
                  <tr key={candidate._id} className="hover:bg-purple-50/50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{candidate.partylist}</td>
