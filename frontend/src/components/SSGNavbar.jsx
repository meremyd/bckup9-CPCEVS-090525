...
export default function SSGNavbar({ 
  currentPage,
  electionId,
  pageTitle,
  pageSubtitle,
  ...
  const navItems = [
    ...
    { 
      label: 'Election', 
      icon: Info, 
      path: electionId ? `/voter/ssg/info?id=${electionId}` : '/voter/ssg/elections', 
      id: 'election',
      disabled: !electionId
    },
    { 
      label: 'Partylist', 
      icon: Users, 
      path: electionId ? `/voter/ssg/partylist?id=${electionId}` : '/voter/ssg/elections', 
      id: 'partylist',
      disabled: !electionId
    },
    { 
      label: 'Results', 
      icon: Trophy, 
      path: electionId ? `/voter/ssg/result?id=${electionId}` : '/voter/ssg/elections', 
      id: 'results',
      disabled: !electionId
    },
    { 
