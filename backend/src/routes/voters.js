...
router.put("/:id/activate", authorizeRoles("admin"), voterController.activateVoter)
router.put("/:id/deactivate", authorizeRoles("admin"), voterController.deactivateVoter)
router.put("/:id/unregister", authorizeRoles("admin"), voterController.unregisterVoter)
