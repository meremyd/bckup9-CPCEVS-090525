...
// // No middleware needed for lookup (public endpoint for validation)
// router.get("/lookup/:schoolId", voterController.lookupVoter)

// // Voter can access their own profile
...
// // Staff-only routes
// router.use(authMiddleware) // Apply to all remaining routes
