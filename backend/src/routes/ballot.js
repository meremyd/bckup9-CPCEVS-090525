...
router.post("/ssg/:ballotId/submit", authMiddleware, authorizeStaffAndVoters("voter", "election_committee"), BallotController.submitSelectedSSGBallot)
router.get("/ssg/:electionId/voter-status", authMiddleware, authorizeStaffAndVoters("voter", "election_committee"), BallotController.getVoterSelectedSSGBallotStatus)
router.get("/ssg/ballot/:ballotId/votes", authMiddleware, authorizeStaffAndVoters("voter", "election_committee", "admin"), BallotController.getSelectedSSGBallotWithVotes)
router.put("/ssg/:ballotId/timer", authMiddleware, authorizeStaffAndVoters("election_committee", "admin"), BallotController.updateSSGBallotTimer)
router.post("/ssg/start", authMiddleware, authorizeStaffAndVoters("voter", "election_committee"), BallotController.startSSGBallot)
...
router.get("/departmental/:electionId/available-positions", authMiddleware, authorizeStaffAndVoters("voter", "election_committee"), BallotController.getAvailablePositionsForVoting)
...
router.get("/departmental/:electionId/:positionId/voter-status", authMiddleware, authorizeStaffAndVoters("voter", "election_committee"), BallotController.getVoterDepartmentalBallotStatus)
...
router.post("/departmental/start", authMiddleware, authorizeStaffAndVoters("voter", "election_committee"), BallotController.startDepartmentalBallot)
