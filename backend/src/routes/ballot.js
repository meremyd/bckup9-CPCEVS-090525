...
// General Ballot APIs (Combined SSG and Departmental)
...
router.post("/ssg/start-with-timeout", authMiddleware, authorizeRoles("voter"), BallotController.startSSGBallotWithTimeout)
