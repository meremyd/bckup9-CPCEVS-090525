...
router.get("/departments", authorizeStaffAndVoters("admin", "election_committee", "sao"),DepartmentalElectionController.getAvailableDepartments)

router.get("/dashboard", authorizeRoles("election_committee", "sao"),DepartmentalElectionController.getDepartmentalDashboardSummary)
...
router.get("/:id/statistics", authorizeStaffAndVoters("admin", "election_committee", "sao"),DepartmentalElectionController.getDepartmentalElectionStatistics)
